...
public class Reservation {
    ...
    public Reservation(String reserved_Id, String reserved_CustomerID, String reserved_VehicleNo, String reserved_ServiceType, double reserved_ServiceFee, Date reserved_Date) {
